...
<body  style="background-color: #ecb807;">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
         ...
         <div class="container">
            <p class="h2 text-light text-center mb-5 mt-5">HALAMAN KELOLA USER</p>
            <center>
            <div class="row">
            <div class="col-11">
            <div class="input-group ">
                <form action="" method="post">
  <input type="search" name="key" class="form-control rounded" size="220" autocomplete="off" placeholder="Masukan Katakunci" aria-label="Search" aria-describedby="search-addon" />
            ...
            <br><a class="btn btn-success text-light btn-lg" href="tambahuser.php">Tambah Data</a></center>
...
<br/><br/>
    ...
    <tbody>
             <tr>
                        ...
                        <td><?= $u["role"]; ?></td>
                        <td>
                            <a href="ubahuser.php?id=<?=$u["id"]; ?>" class="btn btn-primary text-light">Ubah</a> - 
                            <a href="hapususer.php?id=<?=$u["id"]; ?>" onclick="return confirm('Hapus?');" class="btn btn-danger text-light">Hapus</a>  
                        </td>
             </tr>   
