...
$us = query("SELECT * FROM users WHERE id = '$id'")[0];
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="container">
            <p class="h2 text-light text-center mb-5 mt-5">FORM UBAH ADMIN</p>
                
<!-- <div class="d-flex justify-content-xl-center"> -->
<div class="container">
<form action="" method="post">
<div class="mb-3">
    <input type="hidden" class="form-control" name="id" required value="<?= $us["id"];?>">
    <!-- <div id="emailHelp" class="form-text">Isi Nama Lengkap Anda</div> -->
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Nama</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama" required value="<?= $us["nama"];?>">
    <!-- <div id="emailHelp" class="form-text">Isi Nama Lengkap Anda</div> -->
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Username</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="username" required value="<?= $us["username"];?>">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Password</label>
    <input type="password" class="form-control" id="exampleInputPassword1"  name="password" required value="<?= $us["password"];?>">
  </div>
  <div class="mb-3">
  ...
  <a href="user.php" class="btn btn-secondary  btn-lg">Kembali</a>
  </center>
</form>
</div>
