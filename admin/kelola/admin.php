...
<body  style="background-color: #ecb807;">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="container">
            <p class="h2 text-light text-center mb-5 mt-5">HALAMAN KELOLA ADMIN</p>
            <center>
            <div class="row">
            <div class="col-11">
  ...
  <input type="search" name="key" class="form-control rounded" size="220" placeholder="Masukan Katakunci" aria-label="Search" aria-describedby="search-addon" autocomplete="off" />
            ...
            <br><a class="btn btn-success text-light btn-lg" href="tambahadmin.php">Tambah Data</a></center>
...
<br/><br/>
    ...
    <tbody>
             <tr>
                        ...
                        <td><?= $a["role"]; ?></td>
                        <td>
                            <a href="ubahadmin.php?id=<?=$a["id"]; ?>" class="btn btn-primary text-light">Ubah</a> - 
                            <a href="hapusadmin.php?id=<?=$a["id"]; ?>" onclick="return confirm('Hapus?');" class="btn btn-danger text-light">Hapus</a> 
                        </td>
             </tr>   
