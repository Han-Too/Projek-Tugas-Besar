	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="container">
            <p class="h2 text-light text-center mb-5 mt-5">FORM TAMBAH BUKU</p>
...
<form action="" method="post" enctype="multipart/form-data">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama_buku" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Pengarang</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="pengarang" required>
  </div>
  <div class="mb-3">
